    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='swiftventure.m_level')),
            ],
        ),
        migrations.CreateModel(
            name='m_Player',
        ...
        migrations.AddField(
            model_name='m_level',
            name='map',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='swiftventure.map'),
        ),
    ]
